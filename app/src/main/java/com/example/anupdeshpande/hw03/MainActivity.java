...
package com.example.anupdeshpande.hw03;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
                ...
                builder.setTitle("Pick a Movie")
                        .setItems((CharSequence[]) movie_names.toArray(new CharSequence[movie_names.size()]), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent edit_movie = new Intent(MainActivity.this, com.example.anupdeshpande.hw03.edit_movie.class);
                                edit_movie.putExtra(com.example.anupdeshpande.hw03.edit_movie.NAME_TO_EDIT,movies.get(which));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==1 && resultCode==RESULT_OK){
            ...
            Movie movie=(Movie)data.getExtras().getSerializable(com.example.anupdeshpande.hw03.add_movie.MOVIE_KEY);
            movies.add(movie);
        ...
        if(requestCode==2 && resultCode==RESULT_OK){
            Movie updated_movie=(Movie)data.getExtras().getSerializable(com.example.anupdeshpande.hw03.edit_movie.UPDATE_MOVIE_OBJECT);
